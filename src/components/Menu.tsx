...
const Menu = () => {
    ...
    return (
        <div>
            ...
            {open && <div className='bg-red-500 text-white absolute left-0 top-24 w-full h-[calc(100vh-6rem)] flex flex-col items-center gap-8 justify-center text-3xl z-10'>
                {
                    links.map((item) => (
